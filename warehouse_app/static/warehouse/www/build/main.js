...
var SlideopPage = (function () {
    ...
    SlideopPage.prototype.load_next_op = function () {
        ...
        if (this.ops.length < inc) {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__treeops_treeops__["a" /* TreeopsPage */], { picking_id: this.pick_id, source_model: this.source_model, filter: 'Todas' });
        }
        else {
                ...
                },
                {
                    ...
                    handler: function (data) {
                        ...
                        if (data.qty < 0) {
                            ...
                            if (self.op['qty_done'] != data.qty) {
                                self.change_op_value(_this.op_id, 'qty_done', data.qty);
                            }
...
var ProductPage = (function () {
    ...
    ProductPage.prototype.submitScan = function () {
        var scaned = this.barcodeForm.value['scan'];
    ...
    ProductPage.prototype.print = function (model, id, printer_barcode) {
        ...
        self.storage.get('CONEXION').then(function (val) {
            if (val == null) {
                ...
                var odoo = new OdooApi(con.url, con.db);
                odoo.login(con.username, con.password).then(function (uid) {
                    odoo.call(model_src, method, values, context).then(function (value) {
                        if (value) {
                            //AQUI DECIDO QUE HACER EN FUNCION DE LO QUE RECIBO
    ...
    ProductPage = ProductPage_1 = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ToastController */], __WEBPACK_IMPORTED_MODULE_3__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */]])
    ], ProductPage);
    return ProductPage;
    var ProductPage_1;
}());
...
var TreeopsPage = (function () {
    ...
    TreeopsPage.prototype.check_transfer = function () {
        var res = true;
        for (var op in this.pick['pack_operation_ids']) {
    ...
    TreeopsPage.prototype.doTransfer = function (id) {
        var _this = this;
        if (!this.check_transfer) {
            this.presentAlert('Aviso', 'Este trabajo no puede ser validado desde aquí');
            return;
        }
        var self = this;
