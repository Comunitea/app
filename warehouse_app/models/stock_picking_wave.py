...
class StockPickingWave(models.Model):
    ...
    picking_type_id = fields.Many2one('stock.picking.type', 'Picking type', compute="_compute_fields", store=True)
    ...
    location_id = fields.Many2one('stock.location', "Source Location Zone", compute="_compute_fields", store=True)
    location_dest_id = fields.Many2one('stock.location', "Dest Location Zone", compute="_compute_fields", store=True)
